...
INCEPTION_V3_UDO_PLUGIN_HTP_V73         = 'Softmax_v73.json'
...
def create_udo_package(udo_package_path, is_quantized, htp_soc):
    ...
    if htp_soc=="sm8550":
        config_path = os.path.join(SNPE_UDO_PATH, 'config', INCEPTION_V3_UDO_PLUGIN_HTP_V73)
    elif htp_soc:
...
def set_udo_impl(udo_package_path, is_quantized, htp_soc):
    ...
    if htp_soc=="sm8550":
        ...
        package_libs.append(os.path.join('DSP_V73', 'SoftmaxImplLibDsp.cpp'))
    elif htp_soc:
        dsp_impl_lib = os.path.join('DSP_v68', 'SoftmaxImplLibDsp.cpp')
        impl_libs.append(dsp_impl_lib)
        ...
        impl_libs.append(dsp_impl_lib)
        package_libs.append(os.path.join('DSP', 'Softmax.cpp'))
