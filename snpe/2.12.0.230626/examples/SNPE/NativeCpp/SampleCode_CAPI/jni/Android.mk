...
include $(CLEAR_VARS)
LOCAL_MODULE := snpe-samplec
LOCAL_SRC_FILES := main.cpp CheckRuntime.cpp LoadContainer.cpp LoadInputTensor.cpp SetBuilderOptions.cpp Util.cpp PreprocessInput.cpp SaveOutputTensor.cpp
